...
let heldFrom = null; // 'copy' (copiato da un wallet) oppure 'snipe' (moneta nuova trovata da solo)
...
async function snipeLoop() {
  ...
  try {
    ...
    for (const candidate of candidates) {
      if (heldToken) break; // un'altra parte del bot ha appena comprato qualcosa
